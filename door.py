class Door:
  ...
  # Attribute können aber auch mit einem fixen
  # Wert initialisiert werden.
  # Konstruktoren werden als Erstes
  # im Programm angeschrieben.
